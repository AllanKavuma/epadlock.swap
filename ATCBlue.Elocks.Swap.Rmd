...
siteLocations <- siteLocations[siteLocations$Cluster %in% c(3,4, 5, 6, 8, 9, 10, 12, 13, 14), ]
...
pal <- colorFactor(
  palette = c('magenta','skyblue', 'grey','yellow','green', 'dark green', 'red'),#, 'green', "yellow", "orange", "black", "purple", "pink", "brown", "grey"),
